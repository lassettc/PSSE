...
def main():
	...
	pmuLocsSets1 = createRandomPMUsets(pmuLocations, 7, 1) #Create 4 subsets of 16 PMUs
	pmuLocsSets2 = createRandomPMUsets(pmuLocations, 4, 2)  #Create 4 subsets of 12 PMUs
	pmuLocsSets3 = createRandomPMUsets(pmuLocations, 2, 2) #Create 4 subsets of 8 PMUs
	pmuLocsSets4 = createRandomPMUsets(pmuLocations, 2, 4) #Create 4 subsets of 4 PMUs
